// <copyright file="QueryRunnerParameterAttribute.cs" company="BiglerNet">
...
{
    /// <summary>
    /// Provides metadata required to let a <see cref="IQueryRunner"/> connect to a data source.
    /// </summary>
    [AttributeUsage(AttributeTargets.Class, AllowMultiple = true)]
    public class QueryRunnerParameterAttribute : Attribute
    {
        private string? _helpText;

        /// <summary>
        /// Initializes a new instance of the <see cref="QueryRunnerParameterAttribute"/> class.
        /// </summary>
        ...
        public QueryRunnerParameterAttribute(string name, QueryRunnerParameterType propertyType)
        {
            Name = name;
            Type = propertyType;
